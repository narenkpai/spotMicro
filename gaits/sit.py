...
while True:
	...
	#back right
	set_servo_angle(6, (90 -((180-anglevalback)/2)))
	set_servo_angle(9, 180 - elbowvalback)

	#back left
	set_servo_angle(0,(90 +((180-anglevalback)/2)))
	set_servo_angle(1, elbowvalback)
	#front right
	set_servo_angle(7, (90 -((180-anglevalfront)/2)) )
	set_servo_angle(8, 180- elbowvalfront)
	#front left
	set_servo_angle(2,(90 +((180-anglevalfront)/2)) )
	set_servo_angle(3, elbowvalfront)
